...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(evil-escape evil-tutor importmagic org yapfify)
...
before packages are loaded."
  ...
  (unbind-key "M-2" winum-keymap)
  (unbind-key "M-3" winum-keymap)
  (unbind-key "M-4" winum-keymap)
  (unbind-key "M-5" winum-keymap)
  (unbind-key "M-6" winum-keymap)
  (unbind-key "M-7" winum-keymap)
  (unbind-key "M-8" winum-keymap)
  (unbind-key "M-9" winum-keymap)
